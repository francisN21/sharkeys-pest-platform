...
import { Ban, ClipboardList, X } from "lucide-react";
import {
...
export default function AdminCancelledBookingDetailPage() {
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h2 className="text-xl font-bold text-[rgb(var(--fg))]">
                {detail?.service_title ?? "Cancelled Booking"}
              </h2>
              <span
      ...
      {!loading && detail ? (
        <>
          ...
          <SectionCard
            ...
            subtitle="Service, schedule, address, and cancellation details."
          ...
          >
            <div className="grid gap-2 sm:grid-cols-2">
              ...
              <DetailRow label="Cancelled At" value={formatDateTime(detail.cancelled_at)} />
