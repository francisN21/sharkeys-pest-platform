          ...
          >
            ...
            <div className="space-y-4 p-5">
              <div className="rounded-xl border border-white/[0.07] bg-white/[0.03] px-3 py-3 text-sm">
                ...
                <div className="mt-1 truncate font-semibold text-[rgb(var(--fg))]">
                  {serviceTitle ?? "—"}
                </div>
              ...
              <div className="flex items-center justify-end gap-2">
                ...
                <button
                  type="button"
                  className="rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-2 text-sm font-semibold text-red-300 transition hover:bg-red-500/20 active:scale-[0.97] disabled:opacity-60"
                  onClick={onConfirm}
                  disabled={busy}
                >
