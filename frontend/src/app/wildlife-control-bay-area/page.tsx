...
export default function PestControlBayAreaPage() {
  return (
    <PublicBookingPage
      lockedServiceTitle="Wildlife Control"
      pageTitle="Book Wildlife Control"
      pageDescription="New customer booking for Wildlife Control. Choose your date and time, then submit your request."
      backHref="/"
