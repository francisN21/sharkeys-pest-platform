...
export default function PestControlBayAreaPage() {
  return (
    <PublicBookingPage
      lockedServiceTitle="Pest Extermination"
      pageTitle="Book Pest Extermination"
      pageDescription="New customer booking for pest extermination. Choose your date and time, then submit your request."
      backHref="/"
